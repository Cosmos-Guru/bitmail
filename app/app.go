...
func New(
	...
	*/
	...
	app.BitmailKeeper = *bitmailmodulekeeper.NewKeeper(
		appCodec,
		keys[bitmailmoduletypes.StoreKey],
		keys[bitmailmoduletypes.MemStoreKey],
		app.GetSubspace(bitmailmoduletypes.ModuleName),
	)
